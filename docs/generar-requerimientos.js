...
const RF = [
  ...
  ['RF-08', 'El sistema debe permitir modificar los datos de un medicamento existente.', 'Paciente / Cuidador', 'Media', 'ActualizarMedicamento'],
...
const RNF = [
  ['RNF-01', 'Usabilidad', 'El texto base de la interfaz no será inferior a 18 puntos y el paciente podrá ampliarlo hasta un 145 %.', 'Inspección del sistema de diseño y prueba de las tres opciones de tamaño. Verificado.'],
  ['RNF-02', 'Accesibilidad', 'Todo par de texto y fondo cumplirá la relación de contraste 4.5:1 que exige la norma WCAG 2.1 nivel AA.', 'Cálculo de contraste sobre la paleta definida. Verificado.'],
  ...
  ['RNF-07', 'Seguridad', 'Las contraseñas se almacenarán cifradas con bcrypt (factor de costo 10) y nunca en texto plano.', 'Inspección del adaptador de cifrado y de la base de datos. Verificado.'],
