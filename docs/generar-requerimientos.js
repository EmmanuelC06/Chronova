...
const RNF = [
  ...
  ['RNF-17', 'Mantenibilidad', 'El dominio y los casos de uso contarán con pruebas automatizadas que corran sin base de datos.', '166 pruebas en menos de cuatro segundos, 20 de ellas contra la API por HTTP. Verificado.'],
